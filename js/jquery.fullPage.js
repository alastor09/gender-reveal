    ...
    options = $.extend(
      {
        //navigation
        menu: "#bottomMenu",
        anchors: ["Home", "WheelsOrHeels", "Form", "Contact"],
        lockAnchors: false,
        navigation: true,
        navigationPosition: "nav-position",
        navigationTooltips: ["Home", "WheelsOrHeels", "Form", "Contact"],
        ...
        onLeave: function (index, nextIndex, direction) {
          $(".main-content")
            ...
            .removeClass("spirit-fade-in-elements");
        },
        afterLoad: function (anchorLink, index) {
          setTimeout(function () {
            $(".main-content")
              ...
              .addClass("spirit-fade-in-elements");
          }, 25);
        },
        afterRender: null,
        afterResize: null,
